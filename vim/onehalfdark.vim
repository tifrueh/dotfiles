...
hi ColorColumn guibg=#333842 guisp=NONE gui=NONE ctermbg=237 cterm=NONE term=reverse
...
hi StatusLine guifg=#61afef guibg=#333842 guisp=NONE gui=bold,reverse ctermfg=75 ctermbg=237 cterm=bold,reverse term=bold,reverse
hi StatusLineNC guifg=#61afef guibg=#333842 guisp=NONE gui=NONE ctermfg=75 ctermbg=237 cterm=NONE term=reverse
...
hi User1 guifg=#282c34 guisp=NONE gui=bold ctermfg=236 cterm=bold term=bold
hi User2 guifg=#e06c75 guisp=NONE gui=bold ctermfg=167 cterm=bold term=bold
hi User3 guifg=#98c379 guisp=NONE gui=bold ctermfg=150 cterm=bold term=bold
hi User4 guifg=#e5c07b guisp=NONE gui=bold ctermfg=179 cterm=bold term=bold
hi User5 guifg=#61afef guisp=NONE gui=bold ctermfg=75 cterm=bold term=bold
hi User6 guifg=#c678dd guisp=NONE gui=bold ctermfg=170 cterm=bold term=bold
hi User7 guifg=#56b6c2 guisp=NONE gui=bold ctermfg=73 cterm=bold term=bold
hi User8 guifg=#dcdfe4 guisp=NONE gui=bold ctermfg=253 cterm=bold term=bold
hi User9 guifg=#5d677a guisp=NONE gui=bold ctermfg=60 cterm=bold term=bold
...
hi WildMenu guifg=#61afef guibg=#333842 guisp=NONE gui=bold ctermfg=75 ctermbg=237 cterm=bold term=bold
...
if s:t_Co >= 8
  ...
  hi ColorColumn ctermbg=DarkCyan cterm=NONE
  ...
  hi StatusLine ctermfg=Blue ctermbg=Black cterm=bold,reverse
  ...
  hi User1 ctermfg=Black cterm=bold
  hi User2 ctermfg=DarkRed cterm=bold
  hi User3 ctermfg=DarkGreen cterm=bold
  hi User4 ctermfg=DarkYellow cterm=bold
  hi User5 ctermfg=DarkBlue cterm=bold
  hi User6 ctermfg=DarkMagenta cterm=bold
  hi User7 ctermfg=DarkCyan cterm=bold
  hi User8 ctermfg=LightGrey cterm=bold
  hi User9 ctermfg=DarkGrey cterm=bold
  ...
  hi WildMenu ctermfg=Blue ctermbg=Black cterm=bold
...
"    bstatusline #333842     237    #3a3a3a        Black
"     cursorline #333842     237    #3a3a3a     DarkCyan
"           cyan #56b6c2      73    #5fafaf     DarkCyan
"    fstatusline #61afef      75    #5fafff         Blue
