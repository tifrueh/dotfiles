...
if ! [[ -f "${vim_colors_dir}/onehalfdark.vim" ]]; then
    ...
    curl -sSL https://github.com/sonph/onehalf/raw/master/vim/colors/onehalfdark.vim -o "${vim_colors_dir}/onehalfdark.vim"
else
...
if ! [[ -f "${vim_colors_dir}/onehalflight.vim" ]]; then
    ...
    mkdir -p "${vim_colors_dir}"
    curl -sSL https://github.com/sonph/onehalf/raw/master/vim/colors/onehalflight.vim -o "${vim_colors_dir}/onehalflight.vim"
else
...
if input_contains "--configure-kitty" && [[ ! -f "${kitty_dir}/onehalfdark.conf" ]]; then
    ...
    curl -fsSL "https://github.com/sonph/onehalf/raw/master/kitty/onehalf-dark.conf" -o "${kitty_dir}/onehalfdark.conf"
...
if input_contains "--configure-kitty" && [[ ! -f "${kitty_dir}/onehalflight.conf" ]]; then
    ...
    curl -fsSL "https://github.com/sonph/onehalf/raw/master/kitty/onehalf-light.conf" -o "${kitty_dir}/onehalflight.conf"
elif input_contains "--configure-kitty"; then
