...
nvim_doc_dir="${nvim_dir}/doc"
nvim_ftplugin_dir="${nvim_dir}/ftplugin"
nvim_plugin_dir="${nvim_dir}/plugin"
nvim_syntax_dir="${nvim_dir}/syntax"
aerospace_dir="${config_dir}/aerospace"
